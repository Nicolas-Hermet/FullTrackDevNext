...
export default function Dropdown({ children, title, svg }: DropdownProps) {
  ...
  return (
    ...
    >
      ...
      <button
        ...
        onClick={handleClick}
      >
        <span className="sr-only">Show submenu for "{title || 'menu'}"</span>
        <svg
