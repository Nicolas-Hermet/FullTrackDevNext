...
<Image src="/images/le-teletravail-le-guide-complet-chapitre-ii/banner.jpg" alt="banner.jpg" width="6000" height="4000" caption="Photo by Chinh Le Duc on Unsplash"/>Les notifications ça devient n’importe quoi depuis quelques jours, vous êtes noyés sous les coups de fil, vous passez votre vie en visio, les mails s’entassent par liasses de 100. Si vous vous reconnaissez dans cette liste, alors cet article est complètement pour vous.  
